          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="p-10 md:p-16 bg-[#1a1c23]/30">
              ...
              <div className="space-y-8">
                ...
                <div className="mt-8">
                  <a
                    href="https://maps.app.goo.gl/6Fbxyt6W4vWm8RLJ7"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="aspect-video w-full bg-slate-800 rounded-2xl overflow-hidden relative group cursor-pointer block"
                  >
                    <img
