...
const tiers = [
  {
    ...
    price: 'R$ 2.337',
    installment: '12x de R$ 241',
    description: 'Aproveite o primeiro lote com bônus exclusivos para sua formação.',
    features: [
      '2 dias de imersão presencial (Floripa)',
      '2 meses Comunidade Black',
      'Curso Tráfego Meta Ads',
      'Certificado Imperium Digital',
      'Material de apoio estratégico',
      'Acesso ao portal de conteúdos'
    ],
    highlight: true,
            ...
            >
              ...
              <div className="mb-6">
                ...
                <div className="mb-4">
                  ...
                  {tier.installment && <div className="text-sm font-bold text-blue-600 mt-1">ou {tier.installment}</div>}
                </div>
